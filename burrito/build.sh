...
OTP_VERSION="${otp_version}" ARCH=x86_64  LIBC=musl OPENSSL_VERSION="${ssl_version}" ./burrito/download/linux.sh
OTP_VERSION="${otp_version}" ARCH=aarch64 LIBC=musl OPENSSL_VERSION="${ssl_version}" ./burrito/download/linux.sh
